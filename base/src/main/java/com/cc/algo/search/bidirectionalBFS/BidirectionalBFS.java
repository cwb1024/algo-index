package com.cc.algo.search.bidirectionalBFS;
...
public class BidirectionalBFS {
    static class Graph {
        ...
        boolean bidirectionalBFS(int start, int end) {
            ...
            Queue<Integer> startQueue = new LinkedList<>(); // 起点搜索队列
            Queue<Integer> endQueue = new LinkedList<>(); // 终点搜索队列
        ...
        // 从起点扩展搜索路径
        boolean extendFromStart(Set<Integer> startVisited, Queue<Integer> startQueue, Set<Integer> endVisited) {
        ...
        // 从终点扩展搜索路径
        boolean extendFromEnd(Set<Integer> endVisited, Queue<Integer> endQueue, Set<Integer> startVisited) {
